...
public class ExemploClienteHttp {
...
/*----------------------------------------------------------------------------------------------------------------------
                 Http Client API
                     na JDK 11 foi incluida a API do cliente HTTP padronizada
                     substitui a classe HttpUrlConnection
                     A API nova suporta HTTP 1.1 e 2
